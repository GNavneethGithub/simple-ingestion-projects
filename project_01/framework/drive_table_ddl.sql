CREATE TABLE IF NOT EXISTS DRIVE_TABLE (
    ...
    -- Source to Target Audit Process
    SRC_TGT_AUDIT_ENABLED BOOLEAN DEFAULT NULL,
    SRC_TGT_AUDIT_STATUS VARCHAR(50) DEFAULT 'PENDING',
    SRC_TGT_AUDIT_START_TS VARCHAR(50) DEFAULT NULL,
    SRC_TGT_AUDIT_END_TS VARCHAR(50) DEFAULT NULL,
    SRC_TGT_AUDIT_DURATION VARCHAR(50) DEFAULT NULL,
    SRC_TGT_AUDIT_EXP_DURATION VARCHAR(50) DEFAULT NULL,
